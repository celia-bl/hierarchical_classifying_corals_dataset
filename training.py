...
from utils import calculate_means, calculate_intermediate_means, save_pickle
import yaml
        ...
        for _ in range(n_runs):
            ...
            for classifier_name, classifier in flat_classifiers.items():
                ...
                flat_report, flat_hi_report, flat_intermediate_metric, mispredicted_vectors_flat_run = train_and_evaluate(
                    classifier, x_train_subset, y_train_subset, x_test, y_test, hierarchy=hierarchy,  int_labels=intermediate_labels)
